package
{
	...
	import splash.VersionSprite;
		...
		{
			private static const SERVER_KEY:String = "y69r7e29&^%*009fdioaioAksio*6";
...
// pattern two url    - by qunyu		
			...
			private function onInitializerLoaded(e:Event):void
			{
				...
				gameInitializer.addEventListener("initialize.readyToShow", onInitializerReady);
			}
			
			private function onInitializerReady(e:Event):void
			{
				var _gameInitializer:DisplayObject ;
				_gameInitializer = e.currentTarget as DisplayObject;
				_gameInitializer.removeEventListener(("initialize.readyToShow"), onInitializerReady);
				stage.addChild(_gameInitializer);
