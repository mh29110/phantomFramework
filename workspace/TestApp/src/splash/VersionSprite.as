package splash
{
	...
	{
		protected static const topGlobal:Object = {};
		
		protected const VERSION:String = "0.0.1";
		...
		private function addVersionMenu():void
		{
			...
			_currentVersion = VERSION + _modifyDate;
			var contextMenuItem:ContextMenuItem = new ContextMenuItem(_currentVersion);
