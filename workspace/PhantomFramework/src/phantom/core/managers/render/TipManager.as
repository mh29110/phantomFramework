package phantom.core.managers.render
{
	...
	/**鼠标提示管理类*/
	public class TipManager extends Sprite implements IManager{
		...
		private function onStageShowTip(e:UIEvent):void {
			AppCenter.instance.timer.doOnce(GlobalConfig.tipDelay, showTip, [e.data]);
		}
		...
		public function closeAll():void {
			AppCenter.instance.timer.clearTimer(showTip);
