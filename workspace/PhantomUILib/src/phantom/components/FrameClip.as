package phantom.components
{
	...
	public class FrameClip extends ComponentAdapter 
	{
		...
		public function FrameClip(skin:*) {
			super(skin);
		}
		...
		override protected function initializeSkin(skin:*):void {
			...
			_mc.addEventListener(Event.REMOVED_FROM_STAGE, onRemovedFromStage);
		}
		...
		public function set skin(value:String):void {
			if (_skin != value) {
				_skin = value;
				mc = AppCenter.instance.asset.getAsset(value);
			}
		}
